...
module.exports = function (url, options) {
  ...
  var out = new Promise(function (resolve, reject) {
    cancel = reject;
    alert("cbParam" + options.cbParam);
    var cbParam = options.cbParam || 'callback';
    if (options.callbackParam) { //Name) {
      cbName = options.callbackParam; //Name;
      alert("Callback Name " + callbackParam);
    } else {
