function load_li_map() {
    ...
    // ind_desc_FINAL = {
                 // "walk" : [
                           ...
                           // "< / >= 80% dwellings < 1 km of an activity centre with a supermarket",
                 ...
                 // ]
                 // }             
    ind_desc = {'walk_12'      : 'Average distance to closest activity centre, where activity centre is defined as a supermarket < a commercial zoned Mesh Block',
                'walk_14_hard ': 'average number of daily living types present, measured as a score of 0-3, with 1 point for each category of (convenience store/petrol station/newsagent, PT stop, supermarket) < 1600m network distance',
                'walk_14_soft ': 'average number of daily living types present, measured as a score of 0-3, with 1 point for each category of (convenience store/petrol station/newsagent, PT stop, supermarket) < 1600m network distance',
                'walk_16'      : 'dwelling density, calculated as the aggregate sum of dwellings recorded in the meshblock polygons intersecting the 1600m pedestrian-accessible street network once buffered by 50m ("neighbourhood") and divided by the "neighbourhood" area in hectares.',
                'walk_17_hard' : 'composite walkability index, combining street connectivity, dwelling density and daily living destinations',
                'walk_17_soft' : 'composite walkability index, combining street connectivity, dwelling density and daily living destinations',
                'trans_6_hard' : '% of residential dwellings < < 400 m of a public transport stop with a scheduled service at least every 30 minutes between 7am and 7pm on a normal weekday (= a combined measure of proximity and frequency)',
                'trans_6_soft' : '% of residential dwellings < < 400 m of a public transport stop with a scheduled service at least every 30 minutes between 7am and 7pm on a normal weekday (= a combined measure of proximity and frequency)',
                'pos_2_hard'   : '< / >= 100% of residential cadastre < 300 m of any public open space',
                'pos_2_soft'   : '< / >= 100% of residential cadastre < 300 m of any public open space',
                'pos_3_hard'   : '< / >= 50% of residential dwellings < 400 m of any local park >0.4 to <=1 ha',
                'pos_3_soft'   : '< / >= 50% of residential dwellings < 400 m of any local park >0.4 to <=1 ha',
                'pos_4_hard'   : '< / >= 50% of residential dwellings < 800 m of any neighbourhood park >1 ha - <= 5ha',
                'pos_4_soft'   : '< / >= 50% of residential dwellings < 800 m of any neighbourhood park >1 ha - <= 5ha',
                'pos_5_hard'   : '< / >= 50% of residential dwellings < 2 km of any district park >5 ha (<=20 ha)',
                'pos_5_soft'   : '< / >= 50% of residential dwellings < 2 km of any district park >5 ha (<=20 ha)',
                'pos_10_hard'  : '% residential dwellings < 400 m of POS',
                'pos_10_soft'  : '% residential dwellings < 400 m of POS',
                'pos_11_hard'  : '% residential dwellings < 400 m of POS > 1.5 ha',
                'pos_11_soft'  : '% residential dwellings < 400 m of POS > 1.5 ha',
                'food_1'       : 'average ratio of green grocers and/or supermarkets to fast food outlets < 1600m average proportion of supermarkets to supermarkets and fast food outlets combined < 3200 m (as per discussion with JR on 13 July 2018)',
                'food_2_hard'  : '% residential dwellings < 1km of a supermarket',
                'food_2_soft'  : '% residential dwellings < 1km of a supermarket',
                'alc_1'        : 'average number of on-licenses < 400 m',
                'alc_2'        : 'average number of off-licenses < 800 m'}
